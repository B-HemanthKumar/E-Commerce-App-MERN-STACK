import {
  Box, Button, Flex, Heading, Image, Stack, Text } from "@chakra-ui/react";
    ...
    <div>
      ...
      <Box my={"10"}>
        <Stack spacing={"5"} mx={"9"} my={"6"}>
          <Heading textAlign={"left"}>WHAT ARE YOU LOOKING FOR ?</Heading>
          <Box gap="1rem">
            {imagesData.map((item) => (
              <Box
                h={"100%"}
              ...
              >
                ...
                <Button
                  ...
                  width={"50px"}
                  border={"none"}
                  _hover={{ transition: "0,5s", bg: "gray", color: "white" }}
                >
                  SHOP NOW
                </Button>
              </Box>
